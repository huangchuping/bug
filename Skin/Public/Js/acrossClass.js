				...
				case 2:
					$(idd+" table").append('<tr class="bar">'
						...
						+' <input id="go'+boxid+'" class="to-but" type="button" value="&gt;" style="margin-bottom:10px" />'
						 ...
						 +' <br /></td>'
						+'<td width="78%"><select class="'+getOpt('cls',option)+'" style="width:99.8%;" name="touser[]" size="20" multiple="multiple" id="toUser'+boxid+'" onchange=\'return preventSelectDisabled(this)\'>'
						+ getOpt('used',option)
						+'</select></td>'
					+' </tr>');
				...
				case 3:
					$(idd+" table").append('<tr class="bar">'
						...
						+' <input id="go'+boxid+'" class="to-but" type="button" value="&gt;" style="margin-bottom:10px" />'
						 ...
						 +' <input id="backa'+boxid+'"  class="to-but" type="button" value="&lt;&lt;" />'
						 +' <br /></td>'
						+'<td width="70%"><select class="'+getOpt('cls',option)+'" style="width:99.8%;" name="touser[]" size="20" multiple="multiple" id="toUser'+boxid+'" onchange=\'return preventSelectDisabled(this)\'>'
						+ getOpt('used',option)
						+'</select></td>'
					+' </tr>');
