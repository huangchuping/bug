...
<div class="top">
  ...
  <span>Dream缺陷跟踪系统</span></div>
 <div class="content">
   <div>
     <br/>
     <h3 align="center">中文版授权协议 适用于中文用户</h3>
     <p>&nbsp;&nbsp;&nbsp; 版权所有 (c) 2010-2015，九五时代保留所有权利。</p>
     <p>&nbsp;&nbsp;&nbsp; 感谢您选择 Dream缺陷跟踪系统 产品。希望我们的努力能为您提供一个高效快速和强大的权限管理解决方案，节省开发时间与成本，免去重复开发，让您能立即进入关键项目功能的开发。</p>
     <p>&nbsp;&nbsp;&nbsp; 九五时代为 Dream缺陷跟踪系统 产品的开发商，依法独立拥有 Dream缺陷跟踪系统 产品著作权。九五时代网址为   http://www.95era.com，Dream缺陷跟踪系统官方网站网址为 http://www.95era.com，Dream缺陷跟踪系统官方讨论区网址为   http://bbs.95era.com。</p>
     <p>&nbsp;&nbsp;&nbsp; Dream缺陷跟踪系统   著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 Dream缺陷跟踪系统。</p>
     <p>&nbsp;&nbsp;&nbsp; 本授权协议适用且仅适用于 Dream缺陷跟踪系统 2.x 版本，九五时代拥有对本授权协议的最终解释权。</p>
     <h4>I. 协议许可的权利</h4>
     <ol>
       <li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </li>
       <li>您可以在协议规定的约束和限制范围内修改 Dream缺陷跟踪系统 源代码(如果被提供的话)或界面风格以适应您的WEB应用要求。 </li>
     ...
     <ol>
       ...
       <li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 Dream缺陷跟踪系统 的整体或任何部分，未经书面许可，页面页脚处的 Dream缺陷跟踪系统  名称和九五时代官方网站（http://www.95era.com） 的链接都必须保留，而不能清除或修改。 </li>
       <li>禁止在 Dream缺陷跟踪系统 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。 </li>
     ...
     <p>&nbsp;&nbsp;&nbsp; 有关 Dream缺陷跟踪系统 最终用户授权协议、商业授权与技术服务的详细内容，均由 Dream缺陷跟踪系统   官方网站独家提供。九五时代拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>
     <p>&nbsp;&nbsp;&nbsp; 电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装   Dream缺陷跟踪系统，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
   </div>
 </div> 
