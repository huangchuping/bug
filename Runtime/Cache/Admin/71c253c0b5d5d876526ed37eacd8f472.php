<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><html><head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8" content="ie=edge" /><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Dream缺陷跟踪系统 - <?php echo C('CFG_NAME') ?></title><link  id="easySty" rel="stylesheet" type="text/css" href="__ITEM__/__UI__/themes/default/easyui.css"><link type="text/css" rel="stylesheet" href="__ITEM__/__ADMIN.CSS__/index.css"><link id="adminSty" type="text/css" rel="stylesheet" href="__ITEM__/__ADMIN.CSS__/default/style.css"><link rel="stylesheet" type="text/css" href="__ITEM__/__UI__/themes/icon.css"><link rel="stylesheet" href="__ITEM__/__JS__/kindeditor/themes/default/default.css" /><link rel="stylesheet"  href="__ITEM__/__JS__/datepicker/skin/default/datepicker.css"><script type="text/javascript" src="__ITEM__/__JS__/datepicker/WdatePicker.js"></script><script charset="utf-8" src="__ITEM__/__JS__/kindeditor/kindeditor-min.js"></script><script charset="utf-8" src="__ITEM__/__JS__/kindeditor/lang/zh_CN.js"></script><script type="text/javascript" src="__ITEM__/__UI__/jquery.js"></script><script type="text/javascript" src="__ITEM__/__JS__/jquery.cookie.js"></script><script type="text/javascript" src="__ITEM__/__UI__/jquery.easyui.min.js"></script><script type="text/javascript" src="__ITEM__/__UI__/locale/easyui-lang-zh_CN.js"></script><script type="text/javascript" src="__ITEM__/__UI__/plugins/jquery.kindeditor.js"></script><script type="text/javascript" src="__ITEM__/__UI__/plugins/jquery.datepicker.js"></script><script type="text/javascript" src="__ITEM__/__UI__/view/datagrid-scrollview.js"></script><script type="text/javascript" src="__ITEM__/__UI__/view/datagrid-bufferview.js"></script><script type="text/javascript" src="__ITEM__/__JS__/objFunc.js"></script><script type="text/javascript" src="__ITEM__/__JS__/getPinYin.js"></script><script type="text/javascript" src="__ITEM__/__JS__/objClass.js"></script><script type="text/javascript" src="__ITEM__/__JS__/acrossClass.js"></script><script charset="utf-8" src="__ITEM__/__JS__/kindeditor/plugins/image/image.js"></script><script language="javascript"> var cancel = new Array();
 ...
 $(function(){
	...
	if(isskin){
		...
		$("#logoImg").attr("src","__ITEM__/__ADMIN.CSS__/"+isskin+"/logo1.png");
	...
	+"<div class='skin-list' id='default' title='默认蓝'><div class='skin-color' id='defaultBg'></div></div>"
	+"<div class='skin-list' id='black' title='灰黑色'><div class='skin-color' id='blackBg'></div></div>"
	+"<div class='skin-list' id='metro-gray' title='浅灰色'><div class='skin-color' id='mgrayBg'></div></div>"
	+"<div class='skin-list' id='grinder' title='土黃色'><div class='skin-color' id='grinderBg'></div></div>"
	+"<div class='skin-list' id='metro-red' title='粉红色'><div class='skin-color' id='mredBg'></div></div>"
	+"<div class='skin-list' id='cupertino' title='宝石蓝'><div class='skin-color' id='cupertinoBg'></div></div>"
	+"</div>");
...
</script><div class="logo"><img id="logoImg" src="__ITEM__/__ADMIN.CSS__/default/logo1.png" /></div><div class="show"><div class="l2"><span id="localtime" style="margin-right:18px"></span><a href="#" id="chgSkin" title="切换皮肤"><img src="__ITEM__/__IMG__/skin.png" /></a><span class="hi">您好：<strong><?php echo $_SESSION['login']['se_user'] ?></strong> 您有<span id="smsid" class="sms" style="cursor:pointer; margin-left:-3px;" onclick="toShowSms()"></span>条通知 - <?php echo $_SESSION['login']['se_group'] ?> &nbsp;[<a href="javascript:toSendMail();">发邮件</a>] <?php if($group_access>=9999){ ?>[<a href="javascript:toClearCache();">清除缓存</a>]<?php } ?> [<a href="javascript:toRepwd();">修改密码</a>] [<a href="javascript:toSetpwd();">邮箱设置</a>] [<a target="_top" href="__APP__?g=<?php echo GROUP_NAME; ?>&m=Index&a=safe">注销</a>] [<a href="http://www.d-winner.com/html/api/WinnerApi/" target="_blank">帮助</a>]</span></div></div><script runat="server" language="javascript">function tick(){  
    var today;  
    today = new Date();
